    ...
    <div className="mt-12">
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repat bg-cover bg-center">
          ...
          <div className='mt-6'>
            <Button color="white" bgColor={currentColor} text="Downoald" borderRadius="10px" size="md" />
          </div>
        </div>
          ...
          <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780">
            <div className='flex justify-between'>
              ...
              <div className='flex items-center gap-4'>
                <p className='flex items-center gap-2 text-gray-600 hover:drp-shadow-xl'>
                  <span> <GoPrimitiveDot/> </span>
                  <span>Expense</span>
                </p>
                <p className='flex items-center gap-2 text-green-400 hover:drp-shadow-xl'>
                  <span> <GoPrimitiveDot/> </span>
                  <span>Budget</span>
                </p>
              </div>
            ...
            <div className='mt-10 flex gap-10 flex-wrap justify-center'>
              <div className='border-r-1 border-color m-4 pr-10'>
                ...
                <div className='mt-8'> 
                  <p>
                    <span className='text-3xl font-semibold'>$63,438</span>
                  </p>
