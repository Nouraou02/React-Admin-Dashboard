...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between p-2 md:mx-6 relative'>
      ...
      <NavButton title ="Chat" dotColor="#03C9D7" customFunc={() => handelClick('chat')} color={currentColor} icon={<BsChatLeft/>}/>
      <NavButton title ="Notifications" dotColor="#03C9D7" customFunc={() => handelClick('notification')} color={currentColor} icon={<RiNotification3Line/>}/>
